...
- Logo (SVG): [logo.svg](https://angularpdf.com/img/logo.svg)
- Banner (PNG): [pdf-viewer-banner.png](https://raw.githubusercontent.com/intbot/ng2-pdfjs-viewer/master/lib/pdf-viewer-banner.png)
- Social card (PNG): [social card](https://angularpdf.com/img/ng2-pdfjs-viewer-social-card.png)

## In production

Live software using ng2-pdfjs-viewer includes the French data-protection authority's [CNIL PIA](https://github.com/LINCnil/pia) tool, the Finnish National Agency for Education's [AOE library](https://aoe.fi), and [Orange County stormwater tools](https://ocstormwatertools.org). See the [showcase](/showcase) for more.

## Contact

Open an issue or discussion on [GitHub](https://github.com/intbot/ng2-pdfjs-viewer).
