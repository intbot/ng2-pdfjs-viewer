(function() {
  ...
  function applyInitTimeOptions() {
    ...
    try {
      ...
      if (params.get('pdfJsBuild') === 'legacy') {
        PDFViewerApplicationOptions.set('workerSrc', '../legacy/build/pdf.worker.mjs');
        PDFViewerApplicationOptions.set('sandboxBundleSrc', '../legacy/build/pdf.sandbox.mjs');
      }

      const raw = params.get('pjsOptions');
      if (!raw) return;
