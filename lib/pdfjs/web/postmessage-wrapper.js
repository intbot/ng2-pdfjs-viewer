(function() {
  ...
  console.log('🟢 postmessage-wrapper.js: TEST LOG - BUILD_ID:', '2025-07-26T20-30-48-000Z');
  ...
  function updateControl(action, payload) {
    ...
    try {
      switch (action) {
        // Button visibility controls (using helper function)
        case 'show-download':
          ButtonControlHelpers.toggleButtonVisibility('downloadButton', 'secondaryDownload', payload);
          break;
        case 'show-print':
          ButtonControlHelpers.toggleButtonVisibility('printButton', 'secondaryPrint', payload);
          break;
        case 'show-fullscreen':
          ButtonControlHelpers.toggleButtonVisibility('presentationModeButton', null, payload);
          break;
        case 'show-find':
          ButtonControlHelpers.toggleButtonVisibility('viewFind', null, payload);
          break;
        case 'show-bookmark':
          ButtonControlHelpers.toggleButtonVisibility('viewBookmark', null, payload);
          break;
        case 'show-openfile':
          ButtonControlHelpers.toggleButtonVisibility('openFile', 'secondaryOpenFile', payload);
          break;
        ...
        case 'trigger-download':
          if (payload === true) {
            ValidationHelpers.validatePDFAppAndEventBus(() => {
