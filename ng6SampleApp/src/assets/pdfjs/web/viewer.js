...
function webViewerLoad() {
  ...
  // Code1 - Start
  window.applyParameterOverride(config);
  // Code1 - End

  window.PDFViewerApplication = pdfjsWebApp.PDFViewerApplication;
  window.PDFViewerApplicationOptions = pdfjsWebAppOptions.AppOptions;
  var event = document.createEvent('CustomEvent');
  event.initCustomEvent('webviewerloaded', true, true, {}); // Code1. Can notify parent here.
...
function getPDFFileNameFromURL(url) {
  // Code1 - Start
  var providedFileName = window.getUrlParameterByName('fileName');
  if (providedFileName) {
...
function () {
  function PDFHistory(_ref) {
    ...
    this.eventBus.on('pagesloaded', function (evt) {
      // Code1 - Start
      _this.applyActionsOverride(_this);
      // Code1 - End
